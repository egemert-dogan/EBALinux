...
```
Alacarte Uygulamasını açınız. Eğitim bölümünü seçiniz ve "Yeni Öğe" butonuna tıklayınız. Gelen ekranı aşağıdaki gibi doldurduktan sonra "Browse" butonuna tıklayarak 
